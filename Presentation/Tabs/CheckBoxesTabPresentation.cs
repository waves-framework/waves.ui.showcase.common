...
namespace Waves.UI.Showcase.Common.Presentation.Tabs
{
    ...
    /// </summary>
    public class CheckBoxesTabPresentation : ShowcaseTabPresentation
    {
        /// <inheritdoc />
        public CheckBoxesTabPresentation(IWavesCore core) : base(core)
        {
        }
        ...
        /// <inheritdoc />
        public override string Name { get; set; } = "Checkboxes";
        ...
        {
            DataContext = new CheckBoxesTabViewModel(Core);
