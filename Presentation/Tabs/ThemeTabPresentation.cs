...
namespace Waves.UI.Showcase.Common.Presentation.Tabs
{
    ...
    /// </summary>
    public class ThemeTabPresentation : ShowcaseTabPresentation
    {
        /// <inheritdoc />
        public ThemeTabPresentation(IWavesCore core) : base(core)
        {
        }
        ...
        /// <inheritdoc />
        public override string Name { get; set; } = "Theme";
        ...
        {
            DataContext = new ThemeTabViewModel(Core);
