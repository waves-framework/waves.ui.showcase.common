...
namespace Waves.UI.Showcase.Common.Presentation.ViewModel.Tabs
{
    ...
    /// </summary>
    [WavesViewModel(typeof(ComboBoxesTabViewModel))]
    public class ComboBoxesTabViewModel : TabViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public override string Title => "ComboBoxes";
